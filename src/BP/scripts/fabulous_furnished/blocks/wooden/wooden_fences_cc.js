...
world.beforeEvents.worldInitialize.subscribe(eventData => {
  ...
  const destroyTypes = ['oak','birch','dark_oak','spruce','spicewood','acacia','pale','cinder','jungle','mangrove','cherry','warped','crimson','maple'];
  const interactTypes = ['birch','dark_oak','acacia','pale','cinder','spruce','spicewood','jungle','crimson','warped','cherry','mangrove', 'maple'];
  const placeTypes = ['oak','birch','dark_oak','jungle','acacia','cinder','pale','cherry','mangrove','warped','crimson','spruce','spicewood', 'maple'];
